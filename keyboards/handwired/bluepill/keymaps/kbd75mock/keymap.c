...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 KC_LSHIFT, KC_NUBS,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH, KC_RSHIFT,KC_UP,     KC_END, \
   KC_LCTL, KC_LGUI,KC_LALT,                        KC_SPC,                 KC_RALT,DF(1),   KC_RCTL, KC_LEFT, KC_DOWN,   KC_RIGHT ),

  [_FNONE] = LAYOUT_seventy_iso(
             DF(0), KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS, KC_TRNS, KC_NLCK, KC_CALC, KC_TRNS,KC_TRNS, RGB_TOG, \
           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P7,   KC_P8,   KC_P9,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS, \
  RGB_MODE_FORWARD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_TRNS, KC_TRNS,         KC_TRNS, \
           ...
           KC_TRNS, KC_TRNS, KC_TRNS,                  KC_TRNS,                        KC_TRNS, DF(2), KC_TRNS, RGB_SPD,KC_TRNS,RGB_SPI ),
  ...
  RGB_MODE_FORWARD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_P4,  KC_P5,  KC_P6,  KC_PPLS, KC_TRNS, KC_TRNS,         KC_TRNS, \
           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_P1,  KC_P2,  KC_P3,  KC_PAST, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS, \
           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_P0,  KC_PDOT,KC_PENT, KC_PSLS,  KC_TRNS,KC_TRNS,KC_TRNS, \
           KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS,                        KC_TRNS, DF(0), KC_TRNS, RGB_SPD,KC_TRNS,RGB_SPI ),
};
